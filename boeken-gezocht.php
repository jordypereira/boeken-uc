...
try {
  ...
  $queryString = "SELECT * FROM boeken_uc_gezocht";
  ...
  if(isset($_GET['edit']))
  {
    ...
    $queryShowRow = "SELECT * FROM boeken_uc_gezocht WHERE ID = :id";
  ...
  {
    $queryWijzigen = "UPDATE boeken_uc_gezocht SET naam = :naam, titel = :titel, auteur = :auteur, nieuwprijs = :nieuwprijs, vraagprijs = :vraagprijs, opmerking = :opmerking, telnr = :telnr, email = :email WHERE id = :id LIMIT 1";
...
if(isset($_POST['add'])){
  try {
    ...
    $queryString = "INSERT INTO boeken_uc_gezocht (naam, titel, auteur, nieuwprijs, vraagprijs, opmerking, telnr, email) VALUES (:naam, :titel, :auteur, :nieuwprijs, :vraagprijs, :opmerking, :telnr, :email) ";
...
if(isset($_GET['delete'])){
  try {
    $queryString = "DELETE FROM boeken_uc_gezocht WHERE id = :boekid";
 ...
 <html>
   ...
   <body>
     ...
     <h1>Boeken dat we nog nodig hebben</h1>
